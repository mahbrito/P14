...
public class SenhaUtils {
	...
	public static String gerarBCrypt(String senha) {//gera uma nova senha (hash
		...
		BCryptPasswordEncoder bCryptEncoder = new BCryptPasswordEncoder();//instância do BCryptEncoder
		return bCryptEncoder.encode(senha);//a senha é passada por parametro
	}
